defmodule Bumblebee.Text.LlavaText do
  ...
  @moduledoc """
  The LLaVA model for text encoding
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Config do
    # Support loading from the entire LLaVA configuration

    def load(spec, %{"model_type" => "llava", "text_config" => data}) do
      load(spec, data)
    end
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Model do
    def params_mapping(_spec) do
      %{
        "embedder.token_embedding" => "text_model.embed_tokens",
        "decoder.blocks.{n}.self_attention.query" => "text_model.layers.{n}.self_attn.q_proj",
        "decoder.blocks.{n}.self_attention.key" => "text_model.layers.{n}.self_attn.k_proj",
        "decoder.blocks.{n}.self_attention.value" => "text_model.layers.{n}.self_attn.v_proj",
        "decoder.blocks.{n}.self_attention.output" => "text_model.layers.{n}.self_attn.o_proj",
        "decoder.blocks.{n}.self_attention_norm" => "text_model.layers.{n}.input_layernorm",
        "decoder.blocks.{n}.self_attention.rotary_embedding" =>
          "text_model.layers.{n}.self_attn.rotary_emb",
        "decoder.blocks.{n}.ffn.gate" => "text_model.layers.{n}.mlp.gate_proj",
        "decoder.blocks.{n}.ffn.intermediate" => "text_model.layers.{n}.mlp.up_proj",
        "decoder.blocks.{n}.ffn.output" => "text_model.layers.{n}.mlp.down_proj",
        "decoder.blocks.{n}.output_norm" => "text_model.layers.{n}.post_attention_layernorm",
        "output_norm" => "text_model.norm",
